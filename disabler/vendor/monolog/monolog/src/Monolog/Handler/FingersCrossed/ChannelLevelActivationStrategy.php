 ...
 */
namespace HBP_Disabler_Vendor\Monolog\Handler\FingersCrossed;
...
class ChannelLevelActivationStrategy implements ActivationStrategyInterface
{
    ...
    public function __construct($defaultActionLevel, array $channelToActionLevel = [])
    {
        ...
        $this->channelToActionLevel = array_map('HBP_Disabler_Vendor\Monolog\Logger::toMonologLevel', $channelToActionLevel);
    }
    /**
