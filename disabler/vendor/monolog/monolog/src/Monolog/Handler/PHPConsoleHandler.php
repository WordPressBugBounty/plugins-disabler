...
use HBP_Disabler_Vendor\Monolog\Utils;
use HBP_Disabler_Vendor\PhpConsole\Connector;
use HBP_Disabler_Vendor\PhpConsole\Handler as VendorPhpConsoleHandler;
use HBP_Disabler_Vendor\PhpConsole\Helper;
/**
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    {
        if (!class_exists('HBP_Disabler_Vendor\PhpConsole\Connector')) {
