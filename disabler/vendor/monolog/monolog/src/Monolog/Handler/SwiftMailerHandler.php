...
use HBP_Disabler_Vendor\Swift_Message;
use HBP_Disabler_Vendor\Swift;
/**
...
class SwiftMailerHandler extends MailHandler
{
     ...
     */
    public function __construct(\HBP_Disabler_Vendor\Swift_Mailer $mailer, $message, $level = Logger::ERROR, bool $bubble = \true)
    {
