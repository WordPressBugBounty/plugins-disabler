 ...
 */
namespace HBP_Disabler_Vendor\Monolog\Handler;

use HBP_Disabler_Vendor\Elastic\Elasticsearch\Response\Elasticsearch;
use Throwable;
use RuntimeException;
use HBP_Disabler_Vendor\Monolog\Logger;
use HBP_Disabler_Vendor\Monolog\Formatter\FormatterInterface;
use HBP_Disabler_Vendor\Monolog\Formatter\ElasticsearchFormatter;
use InvalidArgumentException;
use HBP_Disabler_Vendor\Elasticsearch\Common\Exceptions\RuntimeException as ElasticsearchRuntimeException;
use HBP_Disabler_Vendor\Elasticsearch\Client;
use HBP_Disabler_Vendor\Elastic\Elasticsearch\Exception\InvalidArgumentException as ElasticInvalidArgumentException;
use HBP_Disabler_Vendor\Elastic\Elasticsearch\Client as Client8;
/**
