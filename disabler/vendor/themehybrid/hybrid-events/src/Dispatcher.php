...
use HBP_Disabler_Vendor\Hybrid\Contracts\Events\Dispatcher as DispatcherContract;
...
use HBP_Disabler_Vendor\Hybrid\Tools\Traits\ReflectsClosures;
...
class Dispatcher implements DispatcherContract
{
    ...
    protected function createCallbackForListenerRunningAfterCommits($listener, $method)
    {
        return function () use ($method, $listener) {
            ...
            $this->container->make('db.transactions')->addCallback(static function () use ($listener, $method, $payload) {
