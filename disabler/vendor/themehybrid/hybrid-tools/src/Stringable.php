...
class Stringable implements JsonSerializable, ArrayAccess
{
     ...
     *
     * @param  \Hybrid\Tools\Stringable|string $value
     * @return bool
     */
     ...
     * @param  int    $limit
     * @return \Hybrid\Tools\Collection<int, string>
     */
