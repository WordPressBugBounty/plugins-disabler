...
use HBP_Disabler_Vendor\Carbon\Factory;
/**
 * @see https://carbon.nesbot.com/docs/
 * @see https://github.com/briannesbitt/Carbon/blob/master/src/Carbon/Factory.php
 *
 * @method \Hybrid\Tools\Carbon create($year = 0, $month = 1, $day = 1, $hour = 0, $minute = 0, $second = 0, $tz = null)
 * @method \Hybrid\Tools\Carbon createFromDate($year = null, $month = null, $day = null, $tz = null)
 * @method \Hybrid\Tools\Carbon|false createFromFormat($format, $time, $tz = null)
 * @method \Hybrid\Tools\Carbon createFromTime($hour = 0, $minute = 0, $second = 0, $tz = null)
 * @method \Hybrid\Tools\Carbon createFromTimeString($time, $tz = null)
 * @method \Hybrid\Tools\Carbon createFromTimestamp($timestamp, $tz = null)
 * @method \Hybrid\Tools\Carbon createFromTimestampMs($timestamp, $tz = null)
 * @method \Hybrid\Tools\Carbon createFromTimestampUTC($timestamp)
 * @method \Hybrid\Tools\Carbon createMidnightDate($year = null, $month = null, $day = null, $tz = null)
 * @method \Hybrid\Tools\Carbon|false createSafe($year = null, $month = null, $day = null, $hour = null, $minute = null, $second = null, $tz = null)
 ...
 * @method \Hybrid\Tools\Carbon fromSerialized($value)
 ...
 * @method \Hybrid\Tools\Carbon|null getTestNow()
 ...
 * @method \Hybrid\Tools\Carbon instance($date)
 ...
 * @method \Hybrid\Tools\Carbon|null make($var)
 * @method \Hybrid\Tools\Carbon maxValue()
 * @method \Hybrid\Tools\Carbon minValue()
 * @method void mixin($mixin)
 * @method \Hybrid\Tools\Carbon now($tz = null)
 * @method \Hybrid\Tools\Carbon parse($time = null, $tz = null)
 ...
 * @method \Hybrid\Tools\Carbon today($tz = null)
 * @method \Hybrid\Tools\Carbon tomorrow($tz = null)
...
class DateFactory
{
    ...
    {
        $defaultClassName = self::DEFAULT_CLASS_NAME;
