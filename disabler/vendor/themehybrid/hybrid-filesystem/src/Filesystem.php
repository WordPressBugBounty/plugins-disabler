...
use HBP_Disabler_Vendor\Hybrid\Tools\LazyCollection;
use HBP_Disabler_Vendor\Hybrid\Tools\Traits\Conditionable;
use HBP_Disabler_Vendor\Hybrid\Tools\Traits\Macroable;
use SplFileObject;
use HBP_Disabler_Vendor\Symfony\Component\Filesystem\Filesystem as SymfonyFilesystem;
use HBP_Disabler_Vendor\Symfony\Component\Finder\Finder;
use HBP_Disabler_Vendor\Symfony\Component\Mime\MimeTypes;
class Filesystem
{
    use Conditionable;
    use Macroable;
    ...
    public function get($path, $lock = \false)
    {
        ...
        throw new \HBP_Disabler_Vendor\Hybrid\Contracts\Filesystem\FileNotFoundException("File does not exist at path {$path}.");
    }
    /**
