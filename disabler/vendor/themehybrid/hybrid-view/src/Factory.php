...
use HBP_Disabler_Vendor\Hybrid\Contracts\Container\Container;
use HBP_Disabler_Vendor\Hybrid\Contracts\Events\Dispatcher;
use HBP_Disabler_Vendor\Hybrid\Contracts\View\Factory as FactoryContract;
use HBP_Disabler_Vendor\Hybrid\Tools\Arr;
use HBP_Disabler_Vendor\Hybrid\Tools\Traits\Macroable;
use HBP_Disabler_Vendor\Hybrid\View\Engines\EngineResolver;
...
class Factory implements FactoryContract
{
     ...
     * @var array
     */
    protected $extensions = ['css' => 'file', 'html' => 'file', 'php' => 'php'];
    /**
    ...
    public function renderEach($view, $data, $iterator, $empty = 'raw|')
    {
        ...
        if (count($data) > 0) {
            foreach ($data as $key => $value) {
                $result .= $this->make($view, [$iterator => $value, 'key' => $key])->render();
            }
        } else {
