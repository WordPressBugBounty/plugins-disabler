...
use HBP_Disabler_Vendor\Hybrid\Contracts\Debug\ExceptionHandler;
use HBP_Disabler_Vendor\Hybrid\Tools\Log\LogManager;
...
use HBP_Disabler_Vendor\Symfony\Component\ErrorHandler\Error\FatalError;
...
class HandleExceptions
{
    ...
    {
        if (!class_exists(LogManager::class) || !static::$app->hasBeenBootstrapped() || static::$app->runningUnitTests()) {
            return;
        }
        try {
     ...
     *
     * @return \Hybrid\Contracts\Debug\ExceptionHandler
     */
