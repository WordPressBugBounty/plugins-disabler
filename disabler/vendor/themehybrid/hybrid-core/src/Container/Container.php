...
use ArrayAccess;
use Closure;
use HBP_Disabler_Vendor\Hybrid\Contracts\Container\Container as ContainerContract;
use HBP_Disabler_Vendor\Hybrid\Util;
use ReflectionClass;
...
class Container implements ContainerContract, ArrayAccess
{
    ...
    public function get($id)
    {
        try {
            ...
            if ($this->has($id) || $e instanceof \HBP_Disabler_Vendor\Hybrid\Contracts\Container\CircularDependencyException) {
                throw $e;
            }
            throw new \HBP_Disabler_Vendor\Hybrid\Container\EntryNotFoundException($id, is_int($e->getCode()) ? $e->getCode() : 0, $e);
        }
    }
    /**
    ...
    public function build($concrete)
    {
        ...
        try {
            ...
            throw new \HBP_Disabler_Vendor\Hybrid\Contracts\Container\BindingResolutionException("Target class [{$concrete}] does not exist.", 0, $e);
        }
        ...
        } catch (\HBP_Disabler_Vendor\Hybrid\Contracts\Container\BindingResolutionException $e) {
            array_pop($this->buildStack);
            throw $e;
        }
        array_pop($this->buildStack);
    ...
    protected function resolveDependencies(array $dependencies)
    {
        ...
        foreach ($dependencies as $dependency) {
            ...
            } catch (\HBP_Disabler_Vendor\Hybrid\Contracts\Container\BindingResolutionException) {
                /*
    ...
    protected function notInstantiable($concrete)
    {
        ...
        throw new \HBP_Disabler_Vendor\Hybrid\Contracts\Container\BindingResolutionException($message);
    }
    /**
     ...
     *
     * @return \Hybrid\Contracts\Container\Container|static
     */
