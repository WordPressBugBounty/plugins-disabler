 ...
 */
use HBP_Disabler_Vendor\Symfony\Polyfill\Intl\Normalizer as p;
if (\PHP_VERSION_ID >= 80000) {
    return require __DIR__ . '/bootstrap80.php';
}
if (!\function_exists('normalizer_is_normalized') && !\function_exists('HBP_Disabler_Vendor\normalizer_is_normalized')) {
    function normalizer_is_normalized($string, $form = p\Normalizer::FORM_C)
    {
        return p\Normalizer::isNormalized($string, $form);
    }
}
if (!\function_exists('normalizer_normalize') && !\function_exists('HBP_Disabler_Vendor\normalizer_normalize')) {
