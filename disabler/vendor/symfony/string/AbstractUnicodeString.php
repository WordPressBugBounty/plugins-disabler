 ...
 */
namespace HBP_Disabler_Vendor\Symfony\Component\String;

use HBP_Disabler_Vendor\Symfony\Component\String\Exception\ExceptionInterface;
use HBP_Disabler_Vendor\Symfony\Component\String\Exception\InvalidArgumentException;
use HBP_Disabler_Vendor\Symfony\Component\String\Exception\RuntimeException;
/**
...
abstract class AbstractUnicodeString extends AbstractString
{
    ...
    {
        $str = clone $this;
        if (!$compat || \PHP_VERSION_ID < 70300 || !\defined('HBP_Disabler_Vendor\Normalizer::NFKC_CF')) {
