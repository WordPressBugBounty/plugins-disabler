...
namespace HBP_Disabler_Vendor\Ramsey\Uuid\Math;

use HBP_Disabler_Vendor\Brick\Math\BigDecimal;
use HBP_Disabler_Vendor\Brick\Math\BigInteger;
use HBP_Disabler_Vendor\Brick\Math\Exception\MathException;
use HBP_Disabler_Vendor\Brick\Math\RoundingMode as BrickMathRounding;
use HBP_Disabler_Vendor\Ramsey\Uuid\Exception\InvalidArgumentException;
use HBP_Disabler_Vendor\Ramsey\Uuid\Type\Decimal;
use HBP_Disabler_Vendor\Ramsey\Uuid\Type\Hexadecimal;
use HBP_Disabler_Vendor\Ramsey\Uuid\Type\Integer as IntegerObject;
use HBP_Disabler_Vendor\Ramsey\Uuid\Type\NumberInterface;
/**
