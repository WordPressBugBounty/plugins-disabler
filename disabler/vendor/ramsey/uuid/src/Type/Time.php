...
namespace HBP_Disabler_Vendor\Ramsey\Uuid\Type;
...
final class Time implements TypeInterface
{
    ...
    public function __construct(float|int|string|IntegerObject $seconds, float|int|string|IntegerObject $microseconds = 0)
    {
