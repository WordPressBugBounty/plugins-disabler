...
use HBP_Disabler_Vendor\Carbon\CarbonPeriodImmutable;
use HBP_Disabler_Vendor\Carbon\Exceptions\UnitException;
use Closure;
use DateTime;
...
trait Converter
{
    ...
    public function __toString()
    {
        ...
        return ($format instanceof Closure) ? $format($this) : $this->rawFormat($format ?: (\defined('HBP_Disabler_Vendor\static::DEFAULT_TO_STRING_FORMAT') ? static::DEFAULT_TO_STRING_FORMAT : CarbonInterface::DEFAULT_TO_STRING_FORMAT));
    }
    /**
    ...
    {
        return $this->avoidMutation()->setTimezone('GMT')->rawFormat(\defined('HBP_Disabler_Vendor\static::RFC7231_FORMAT') ? static::RFC7231_FORMAT : CarbonInterface::RFC7231_FORMAT);
    }
    /**
