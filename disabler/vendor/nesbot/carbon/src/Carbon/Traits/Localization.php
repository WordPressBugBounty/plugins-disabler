 ...
 */
namespace HBP_Disabler_Vendor\Carbon\Traits;

use HBP_Disabler_Vendor\Carbon\CarbonInterface;
use HBP_Disabler_Vendor\Carbon\Exceptions\InvalidTypeException;
use HBP_Disabler_Vendor\Carbon\Exceptions\NotLocaleAwareException;
use HBP_Disabler_Vendor\Carbon\Language;
use HBP_Disabler_Vendor\Carbon\Translator;
use HBP_Disabler_Vendor\Carbon\TranslatorStrongTypeInterface;
use Closure;
use HBP_Disabler_Vendor\Symfony\Component\Translation\TranslatorBagInterface;
use HBP_Disabler_Vendor\Symfony\Component\Translation\TranslatorInterface;
use HBP_Disabler_Vendor\Symfony\Contracts\Translation\LocaleAwareInterface;
use HBP_Disabler_Vendor\Symfony\Contracts\Translation\TranslatorInterface as ContractsTranslatorInterface;
// @codeCoverageIgnoreStart
if (interface_exists('HBP_Disabler_Vendor\Symfony\Contracts\Translation\TranslatorInterface') && !interface_exists('HBP_Disabler_Vendor\Symfony\Component\Translation\TranslatorInterface')) {
    class_alias('HBP_Disabler_Vendor\Symfony\Contracts\Translation\TranslatorInterface', 'HBP_Disabler_Vendor\Symfony\Component\Translation\TranslatorInterface');
}
