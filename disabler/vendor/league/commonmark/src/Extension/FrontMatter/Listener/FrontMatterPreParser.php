...
namespace HBP_Disabler_Vendor\League\CommonMark\Extension\FrontMatter\Listener;

use HBP_Disabler_Vendor\League\CommonMark\Event\DocumentPreParsedEvent;
use HBP_Disabler_Vendor\League\CommonMark\Extension\FrontMatter\FrontMatterParserInterface;
