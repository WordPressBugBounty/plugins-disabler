 ...
 */
namespace HBP_Disabler_Vendor\League\CommonMark\Extension\DescriptionList\Node;

use HBP_Disabler_Vendor\League\CommonMark\Node\Block\AbstractBlock;
use HBP_Disabler_Vendor\League\CommonMark\Node\Block\TightBlockInterface;
