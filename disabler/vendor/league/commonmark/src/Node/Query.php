 ...
 */
namespace HBP_Disabler_Vendor\League\CommonMark\Node;

use HBP_Disabler_Vendor\League\CommonMark\Node\Query\AndExpr;
use HBP_Disabler_Vendor\League\CommonMark\Node\Query\OrExpr;
final class Query
{
