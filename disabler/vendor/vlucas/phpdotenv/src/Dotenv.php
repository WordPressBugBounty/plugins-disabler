...
namespace HBP_Disabler_Vendor\Dotenv;

use HBP_Disabler_Vendor\Dotenv\Exception\InvalidPathException;
use HBP_Disabler_Vendor\Dotenv\Loader\Loader;
use HBP_Disabler_Vendor\Dotenv\Loader\LoaderInterface;
use HBP_Disabler_Vendor\Dotenv\Parser\Parser;
use HBP_Disabler_Vendor\Dotenv\Parser\ParserInterface;
use HBP_Disabler_Vendor\Dotenv\Repository\Adapter\ArrayAdapter;
use HBP_Disabler_Vendor\Dotenv\Repository\Adapter\PutenvAdapter;
use HBP_Disabler_Vendor\Dotenv\Repository\RepositoryBuilder;
use HBP_Disabler_Vendor\Dotenv\Repository\RepositoryInterface;
use HBP_Disabler_Vendor\Dotenv\Store\StoreBuilder;
use HBP_Disabler_Vendor\Dotenv\Store\StoreInterface;
use HBP_Disabler_Vendor\Dotenv\Store\StringStore;
class Dotenv
{
    /**
     * The store instance.
